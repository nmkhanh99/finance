...
import { createRecurring, deleteRecurring, runRecurringNow } from "./actions";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        {items.map((r) => (
          <div key={r.id} className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-white/10 bg-white/5 px-4 py-3">
