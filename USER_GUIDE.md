...
4. **Đa tiền tệ**: mỗi khoản chi có thể khác tiền tệ (VD đi nước ngoài: vài khoản USD, vài khoản VND). Danh sách hiện số tiền gốc kèm "≈ VND". **Báo cáo phân tích** và **Phương án thanh toán** quy đổi tất cả về **VND** theo tỷ giá ở trang **Tỷ giá** — nhớ cập nhật tỷ giá cho đúng (thiếu tỷ giá thì khoản đó tạm coi như VND).
5. Xem **Báo cáo phân tích** (mỗi người đã trả / phải chịu / chênh lệch) và **Phương án thanh toán** (ai chuyển cho ai bao nhiêu — tối thiểu số lần chuyển).
